        ...
        <div className='pt-8'>
            <div className='container font-poppins  md:px-0 px-2 mx-auto'>
                ...
                <div className='flex flex-col items-center space-y-1'>
                    ...
                    <h3 className='text-3xl  text-[#3D3E48] font-bold'>What they say about us</h3>
                </div>
                ...
                <div className='pt-8 grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-6'>
                    {
                        testimonials.map((item) =>
                            <div key={item.id} className='space-y-5 bg-slate-50 shadow border  text-[#3D3E48] transition-all duration-300 delay-500 hover:shadow-xl hover:text-[#FFFFFF] shadow-[#ffff] hover:bg-[#43B97F] p-4 rounded-xl'>
