      ...
      <div className="container font-poppins grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-12 mx-auto">
        ...
        <div className="space-y-5">
          ...
          <p className="font-normal">
            The TourHub footer serves as a hub for essential information,
            featuring our mission statement, contact details, and social media
            links. It reinforces our commitment to exceptional travel
            experiences while ensuring easy access to support. Stay connected
            with us and discover your next adventure!
          </p>
