...
const PackageFilterCard = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-start gap-y-2 max-w-[473px] self-start min-h-[150px] md:min-h-[263px] ">
      ...
      {/* pricing */}
      <div className="w-full px-6 lg:w-[200px] h-auto md:h-[263px] md:border-l-[1px] md:border-[#E7E6E6] flex flex-row md:flex-col justify-between items-center  md:mt-0">
        <div>
        ...
        <div className="flex flex-col justify-center items-center gap-y-4">
          <p className="text-14px md:text-[15px] text-tourHub-title2 font-normal leading-[21px]">
            From <span className="font-medium">${price}</span>
          </p>
          <Link
            href={`/packages/${_id}`}
            className="border-[1px] border-tourHub-green-dark  px-3 md:px-4 py-1 md:py-2 rounded-12px text-[13px] md:text-[15px] font-medium font-inter leading-28px text-tourHub-green-dark hover:bg-tourHub-green-dark hover:text-white transition-all duration-300"
          >
            View Details
          </Link>
        </div>
