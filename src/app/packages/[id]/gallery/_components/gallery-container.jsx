    ...
    <div className="bg-gray-100 h-[200px] mt-[60px]">
      <div className="container flex gap-y-4 flex-col h-full justify-center items-center">
        <motion.h3
          ...
          className="text-tourHub-green-dark text-23px max-w-[650px]"
        >
          {name}
        </motion.h3>
...
const GalleryImage = React.memo(({ index, src }) => {
  return (
    <motion.div
      ...
      className="relative w-full max-w-[300px] rounded-12px h-[300px] overflow-hidden"
    >
      <Image
        src={src}
        alt="image"
      ...
      33vw"
        className="rounded-12px hover:scale-110 transition-transform duration-300"
      />
    </motion.div>
  );
});
