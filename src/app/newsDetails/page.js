          ...
          <div className="col-span-4 md:col-span-3">
            ...
            <div className="mt-5 md:mt-10">
              ...
              <p className="text-base font-normal leading-7 text-tourHub-title text-16px">
                ...
                Accusamus laborum et voluptas nostrum inventore? Distinctio
                architecto facere quasi voluptatem alias reiciendis minus
                incidunt non, ut dolores! Sapiente, quis voluptas. Ducimus
                perferendis necessitatibus ab obcaecati ipsum vero quibusdam
                exercitationem mollitia praesentium accusantium non pariatur,
                quaerat aspernatur doloribus nam odio. Aspernatur, id. Totam
                ullam voluptatum praesentium officiis voluptatibus modi ducimus,
                molestiae dolorem iure cumque repellendus ex eum autem
                temporibus quo dolor expedita veniam blanditiis illum eveniet
                incidunt. Nulla delectus tenetur quia! Animi illo cum
                necessitatibus eos quod fugiat sit, quaerat, officia itaque
                nostrum nulla iure recusandae! Error ad voluptates quae. Dicta,
                tenetur!
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-3">
                {categories.map((category) => (
                  <Link
                    key={category.id}
                    href={`/news`}
                    className="text-tourHub-title text-14px text-base font-normal hover:opacity-80 transition duration-300"
                  >
                    {category.name}
                  </Link>
                ))}
